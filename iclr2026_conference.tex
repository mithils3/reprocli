...
loop~\citep{yao2023react}. The harness supplies every tool a reproduction
requires and no guidance beyond them, so it neither restricts the model nor
hand-holds it, and outcomes measure the model rather than our scaffolding. The agent receives the paper's \LaTeX{} source,
