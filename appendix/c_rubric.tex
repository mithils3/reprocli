...
score of 1 becomes \texttt{unverifiable}. We froze the rubric text three days
...
flag zeroes the score. Figure~\ref{fig:app-cd-flag-kinds} shows the flags the
auditor raised, by kind and severity.
