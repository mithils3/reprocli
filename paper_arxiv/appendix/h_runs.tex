...
% Figure: figures/run_timelines.html via make_fig_portrait.py + activity.py (per-round
...
\caption{Decisive round 53 of DeepSeek-V4-Flash on TabDPT (arXiv~2410.18164), with the agent's reasoning, the tool call, and its result.}
...
22 the branch matched nothing, as Figure~\ref{fig:app-h1-zoom-2} shows; the agent changed the two comparisons, and
...
\caption{Decisive round 22 of DeepSeek-V4-Flash on LayerNorm Scaling (LNS) (arXiv~2502.05795), with the agent's reasoning, the tool call, and its result.}
...
Figure~\ref{fig:app-h1-zoom-4} shows, while
...
Figure~\ref{fig:app-h1-zoom-5} shows, and for the 96-instance live
...
Figure~\ref{fig:app-h1-zoom-6} shows. The auditor
...
inference in 0.84 H100-hours, and round 12, shown in Figure~\ref{fig:app-h1-zoom-7}, read 39 percent at two
...
Figure~\ref{fig:app-h1-zoom-8} shows, repeated
...
Figure~\ref{fig:app-h1-zoom-9} shows, and the
...
rank matching the paper's compression, as Figure~\ref{fig:app-h1-zoom-10}
...
\input{appendix/h_traces}  % resource and auditor traces of the ten runs
