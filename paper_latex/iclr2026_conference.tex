...
and 3 papers, and exactly one paper saturates the 192-hour cap. Of the 100
papers, 94 first appeared as preprints in 2025, which limits the exposure of
their artifacts in current training corpora.
...
\paragraph{Match bars and tolerance.} For 67 of the 100 evaluation papers the
match bar is a point estimate. For 18 the run must beat a stated baseline,
for 12 it must clear a reported threshold, and for the remaining 3 it must
