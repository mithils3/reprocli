...
\paragraph{Agent harness.} We run every agent in a deliberately thin
ReAct-style tool loop~\citep{yao2023react} so that outcomes measure the model
rather than our scaffolding. The agent receives the paper's \LaTeX{} source,
