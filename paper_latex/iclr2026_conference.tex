...
\paragraph{Metric} - We report the average reproduction score as our primary metric. We also provide  \% of papers reproduced as a metric.
We also report of the token usage of every model evaluated, and the total cost of the running the benchmark for each model, which consitis of it's API Pricing  
\subsection{Results}
