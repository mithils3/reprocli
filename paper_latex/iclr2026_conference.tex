...
Appendix~\ref{app:harness} records pinned versions, serving configuration,
...
We also report of the token usage of every model evaluated, and the total cost of the running the benchmark for 
\subsection{Results}
